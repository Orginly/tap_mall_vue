            ...
            <div class="item-price bgf5">
              <div class="price-box clearfix">
                <div class="price-panel pull-left">
                  售价：<span class="price"
                    >￥<span v-text="result.price"></span>
                    <s class="fz16 c9"
                      >￥<span v-text="result.cost_price"></span></s
                  ></span>
                </div>
              </div>
            </div>
            ...
            <div class="item-key">
                ...
                <div class="amount-box">
                  ...
                  <div class="item-stock">
                    <span style="margin-left: 10px"
                      >库存 <b id="Stock" v-text="result.stock"></b> 件</span
                    >
                  </div>
                </div>
              </div>
              <div class="item-action clearfix bgf5">
                <a
                  v-if="result.stock <= 0"
                  disabled="disabled"
                  style="float: left; background: gray; border: gray"
                  rel="nofollow"
          ...
          <div class="tab-content">
            ...
            >
              <div class="item-detail__info clearfix">
                <div class="record">
                  商品编号：<span
                    v-if="result && result.detail"
                    v-text="result.detail.d1.商品编号"
                  ></span>
                </div>
                <div class="record">
                  上架时间：<span
                    v-if="result && result.detail"
                    v-text="result.detail.d1.上架时间"
                  ></span>
                </div>
                <div class="record">
                  商品毛重：<span
                    v-if="result && result.detail"
                    v-text="result.detail.d1.商品毛重"
                  ></span>
                </div>
                <div class="record">
                  商品库存：<span
                    v-if="result && result.detail"
                    v-text="result.detail.d1.商品库存"
                  ></span>
                </div>
              </div>
              <div class="rich-text">
            ...
            >
              <div class="descCate-content bgf5">
                <dd class="dc-idsItem selected">
                  <a href="#desc-module-1"
                    ><i class="iconfont icon-dot"></i> 产品图</a
                  >
                </dd>
                <dd class="dc-idsItem">
                  <a href="#desc-module-2"
                    ><i class="iconfont icon-selected"></i> 细节图</a
                  >
                </dd>
                <dd class="dc-idsItem">
                  <a href="#desc-module-3"
                    ><i class="iconfont"></i> 尺寸及试穿</a
                  >
                </dd>
                <dd class="dc-idsItem">
                  <a href="#desc-module-4"
                    ><i class="iconfont"></i> 模特效果图</a
                  >
                </dd>
                <dd class="dc-idsItem">
...
import { detail, recommend, addCart, cartCount } from "../lib/interface";
